package com.LYFT.BookingMicroService.Service;
...
public class BookingService {
    ...
    public ResponseEntity<String> addBooking(BookingsModel input){
        try{
            ...
            if(input.getPostedEmail().equals(input.getUserEmail())) return new ResponseEntity<>("You can't book the rides you posted",HttpStatus.BAD_REQUEST);
